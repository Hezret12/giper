...
export default function SwipperPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        const responseProducts = await axios.get(
          `https://gipertm.com/_next/data/lzpeNcavMowH-dhR8rmNe/tk/productItems/productPresents/13890374.json?categoryCode=chocolate_bar&sort=date&order=desc&id=13890374`
        );
  ...
  const loadMoreData = async (offset) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://gipertm.com/api/v4/products/presents?store=GIPERM%2CGIPERMARKET$categoryCode=coffeetea&sort=discountPercent&order=desc&offset=${offset}&lang=tk`
      );
